...
onready var modules = [
	...
	$ARM_ARM/ARM_ARM2/ARM_ARM3/ARM_ARM4/ARM_ARM5/ARM_ARM6/ARM_ARM7/ARM_ARM8/ARM_ARM9/ARM_ARM10,
...
func _ready():
	...
	for m in modules:
		if m != target:
			m.self_modulate = Color(0.01, 0.08, 0.01, 0.5)
...
func genColl():
	...
	if enabled:
		...
		$Area2D/LightOccluder2D.occluder = OccluderPolygon2D.new()
